...
main() {
  ...
  uv pip install setuptools_scm cmake ninja
  # Build vllm without CUDA - disable CUDA cmake checks
  VLLM_TARGET_DEVICE=cpu \
  CMAKE_ARGS="-DVLLM_TARGET_DEVICE=cpu -DCMAKE_DISABLE_FIND_PACKAGE_CUDA=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_CUDAToolkit=TRUE" \
