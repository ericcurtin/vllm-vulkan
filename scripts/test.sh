...
smoke_test() {
  ...
  # Use correct loopback interface name for platform (lo0 on macOS, lo on Linux)
  ...
  # --swap-space reduced to leave more memory for KV cache
  # --enforce-eager avoids memory for graph compilation
